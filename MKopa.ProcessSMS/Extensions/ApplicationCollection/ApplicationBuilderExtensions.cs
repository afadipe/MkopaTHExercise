namespace MKopa.ProcessSMS.Extensions.ApplicationCollection
{
    using Microsoft.AspNetCore.Builder;
    using Microsoft.AspNetCore.Diagnostics;
    using Microsoft.AspNetCore.Hosting;
    using Microsoft.AspNetCore.Http;
    using MKopa.ProcessSMS.Extensions;
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void UseSwaggerWithUi(this IApplicationBuilder @this, IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopmentOrStaging())
            {
                ...
                @this.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "MKOPA ProcessSMS Micro API V1");
                });
            }
